...
public class ProducerConsumerTest {
    ...
    static void test(Storage storage){
        //仓库对象
        //Storage storage = new AwaitSignalStorage();
...
class AwaitSignalStorage extends Storage{
    ...
    public void produce(int num){
        System.out.println("【要生产的产品数量】:" + num + "-----> " + "进来了");
        //获得锁
        lock.lock();
        ...
        for (int i = 0; i < 3 ; i++){
            try {
                ...
                System.out.println("【要生产的产品数量】:" + num + "/t 睡眠:" + i);
        ...
        // 唤醒其他所有线程
        System.out.println("【要生产的产品数量】:" + num + "-----> " + "解锁了");
        full.signalAll();
        empty.signalAll();
    ...
    public void consume(int num){
        System.out.println("【要消费的产品数量】:" + num + "-----> " + "进来了");
        //获得锁
        lock.lock();
        ...
        for (int i = 0; i < 3 ; i++){
            try {
                TimeUnit.SECONDS.sleep(1);
                System.out.println("【要消费的产品数量】:" + num + "/t 睡眠:" + i);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }
        ...
        // 唤醒其他所有线程
        System.out.println("【要消费的产品数量】:" + num + "-----> " + "解锁了");
        full.signalAll();
        empty.signalAll();
